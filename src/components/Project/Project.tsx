      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jebastinjvr" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Tamilnadu Tourism App</h3>
              <p> Developed a serverless Tourism app using Kotlin, SQL, API Gateway, and IBMDB, enabling users to view destiny, path venue, and access details through an interactive UI, leveraging serverless architecture for scalability and cost-efficiency. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Kotlin</li> <li>API Gateway</li> <li>SQLDB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Grubbers Obligation App</h3>
              <p>
                Developed an interactive application using Java, Natural language Prototype using Java Frame, Used for Daily Workers to get job, Also it provided features for translation.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Machine Learning with Application to Object Recognition</h3>
              <p>
                Developed a highly Natural Language processing Model, achieving 100% accuracy, used for recognize the object in the frame, Concept of ML with NP.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
